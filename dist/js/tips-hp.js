define(function() {
	(function(win, doc) {
		...
		if (doc.body) {
			...
			newEle.id = "tips-hp";
			newEle.innerHTML = '<div class="flexBox-hp"><p class="word-hp">∫·∆¡¬“‘„‘„£¨ ˙∆¿¥ø¥∞…</p></div>';
			newEle.addEventListener("touchmove", function(event) {
				event.preventDefault();
			});
			doc.body.appendChild(newEle);
		} else {
			var html_hp = '<div class="tips-hp" id="tips-hp" ontouchmove="return !1"><div class="flexBox-hp"><p class="word-hp">∫·∆¡¬“‘„‘„£¨ ˙∆¿¥ø¥∞…</p></div></div>';
			doc.write(html_hp);
		}
